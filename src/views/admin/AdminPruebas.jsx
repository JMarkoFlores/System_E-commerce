      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Recomendado: ≥30 para t-test válido</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
            <p className="text-xs text-gray-500 mt-1">Número de recomendaciones a evaluar</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Semilla</label>
            <input
              type="number"
              value={config.seed}
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
            <p className="text-xs text-gray-500 mt-1">Para reproducibilidad</p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                <p className="text-sm text-green-700">Total compras</p>
                <p className="text-2xl font-bold text-green-900">
                  {resultados.statsDataset.totalCompras}
                </p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4">
                <p className="text-sm text-purple-700">Compras / usuario</p>
                ...
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    {Object.keys(resultados.resultadosBaselines).map((nombre) => (
                      <th key={nombre} className="px-4 py-3 text-center font-semibold text-gray-700">
                        {nombre}
                      </th>
                    ))}
                  </tr>
                  ...
                  {metricasVisibles.map((m) => (
                    <tr key={m.key} className="hover:bg-gray-50">
                      ...
                      {Object.entries(resultados.resultadosBaselines).map(([nombre, res]) => (
                        <td key={nombre} className="px-4 py-3 text-center text-gray-600">
                  ...
                  {Object.entries(resultados.intervalosRN).map(([key, ic]) => {
                    ...
                    return (
                      <tr key={key} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-center">{ic.media.toFixed(3)}</td>
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {Object.entries(resultados.testsPorMetrica[metrica]).map(
                          ([baseline, test]) => (
                            <tr key={baseline} className="hover:bg-gray-50">
                              <td className="px-4 py-2 font-medium text-gray-800">{baseline}</td>
